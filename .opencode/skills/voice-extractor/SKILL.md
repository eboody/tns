...
This keeps the resulting voice skill honest and easier to apply.

## Review Checklist

- Was corpus size sufficient?
- Was extraction quality assessed?
- Were adult/child differences detected when present?
- Were structure, lexicon, syntax, paragraphs, attribution, and restraint all analyzed?
- Were stable voice patterns separated from boilerplate and case artifacts?
- Does the generated skill enforce style-only rewriting?
- Are low-confidence patterns labeled honestly?
- Is there evidence for the major style claims?
- Is the output reusable as a repo-local voice skill?
